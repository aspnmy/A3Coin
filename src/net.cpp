...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "a3coin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    //{"a3coin.org", "seed.a3coin.org"},
    {"a3coin.com", "seed.a3coin.com"},
};
...
void ThreadOpenConnections2(void* parg)
{
    ...
    for(;;)
    {
        ...
        for(;;)
        {
            ...
            // stop this for(;;), and let the outer for(;;) run again (which sleeps, adds seed nodes, recalculates
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. a3coin is probably already running."), addrBind.ToString().c_str());
        else
